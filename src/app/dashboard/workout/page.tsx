          ...
          <div className="glass-card p-6 rounded-3xl space-y-4">
            <div className="flex justify-between items-center pb-2">
              ...
              <select
                ...
                className="text-xs bg-zinc-100 dark:bg-zinc-900 border border-black/5 dark:border-white/5 rounded-lg px-2.5 py-1.5 text-zinc-700 dark:text-zinc-300 focus:outline-none"
              >
